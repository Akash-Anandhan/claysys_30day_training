...
namespace ShoppingCartApp.Services
{
    public partial class AdminService
    {
            ...
            int pageSize = 50)
        {
            ...
            var ratingDistribution = new List<int> { 0, 0, 0, 0, 0 }; // Index 0 = 1-star, Index 4 = 5-star
            
            var allReviewsForChart = await _context.Reviews.ToListAsync();
            foreach (var review in allReviewsForChart)
            {
                var index = Math.Min(4, Math.Max(0, review.Rating - 1));
