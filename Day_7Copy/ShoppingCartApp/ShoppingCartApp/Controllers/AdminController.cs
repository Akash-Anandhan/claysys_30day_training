...
namespace ShoppingCartApp.Controllers
{
    ...
    public class AdminController : BaseController
    {
        ...
        // POST: /Admin/PopulatePaymentMethods
        [HttpPost]
            ...
            int page = 1)
        {
            ...
            // Always populate ViewBag values
            ViewBag.SearchQuery = searchQuery;
            ViewBag.MinRating = minRating;
            ViewBag.SortBy = sortBy;
            
            if (result.Succeeded && result.ViewModel is AdminReviewsResultDto dto)
            {
                ViewBag.RatingDistribution = dto.RatingDistribution;
            }
            else
            {
                // Ensure RatingDistribution is always set to avoid chart errors
